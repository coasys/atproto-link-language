...
/**
 * Transport implementation for the WASM runtime.
 *
 * Until the executor adds `http-ext` support, calling this transport
 * throws a clear error so that misconfiguration is immediately visible.
 */
